...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='ur10_description').find('ur10_description')
    default_model_path = os.path.join(pkg_share, 'urdf/ur10.urdf')
